...
2. Review vendor quality certificates and fill designated Google form.
3. For sample PCBs:
   - inspect under microscope
   - compare against reference PCB
   - record notes for defects
4. Export completed form from GoogleDoc as:
   - Excel file
   - PDF file
...
1. Count boards.
2. Review certificates and complete form.
...
6. Upload completed forms (Excel + PDF) to HWDB.
...
1. Download the specified `.tgz` timing package from project source.
2. Extract it fully.
